...
st.title('Opening Permits in Chicago')

st.markdown("""
            This application uses public data to count the number of street opening
...
def get_data(start,end):
    ...
    endpoint = 'https://data.cityofchicago.org/resource/pubx-yq2d.csv?'
